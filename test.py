...
def test_get_task_plan_steps():
    ...
    new_nodes = [{'node_type': 'class', 'name': 'Lamborghini', 'inputs': '', 'outputs': '', 'is parent': 'Car', 'parent class': 'True', 'short description': 'A class that represents a Lamborghini car and inherits from the Car class.', 'file': 'Lamborghini.py'}]
