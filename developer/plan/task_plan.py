...
def get_task_plan(gpt, table_completion_gpt, prompt, target_dir, relevant_files=None, relevant_nodes=None, new_nodes=None, exclude_files=None, rexclude_files=None):
    # Relevant files
